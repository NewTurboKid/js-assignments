...
function getPokerHandRank(hand) {
    ...
    if (signSame && straight) return PokerRank.StraightFlush;
    if (freq.four === 1) return PokerRank.FourOfKind;
    if (freq.three === 1 && freq.pairs === 1) return PokerRank.FullHouse;
    if (signSame) return PokerRank.Flush;
    if (straight) return PokerRank.Straight;
    if (freq.three === 1) return PokerRank.ThreeOfKind;
    if (freq.pairs === 2) return PokerRank.TwoPairs;
    if (freq.pairs === 1) return PokerRank.OnePair;
